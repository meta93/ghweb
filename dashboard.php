                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row page-title-div">
                             <nav class="navbar top-navbardashboard-stat bg-success">
                                <div class="col-sm-6">
                                    <h2 class="title"><strong>Dashboard</h2>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-danger" href="Casualties_dashboard.php">
<?php 
$sql1 ="SELECT id from tblcitizens ";
...
?>
                                            ...
                                            <span class="name">  Roads and Safety Commission</span>
                                    ...
                                    <!-- /.col-lg-3 col-md-3 col-sm-6 col-xs-12 -->
                                     <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-nature" href="">
<?php 
$sql ="SELECT id from  primary_energy_supply_and_final_energy_consumption_2013 ";
...
?>
                                            ...
                                            <span class="name">Financial Institutions </span>
     ...
     <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-nature" href="#">
<?php 
$sql ="SELECT id from  tbllocalgov ";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$totallocalgov=$query->rowCount();
?>
                                            <span class="number counter"><?php echo htmlentities($totallocalgov);?></span>
